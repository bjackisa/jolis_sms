    ...
    <div class="col-lg-4">
        <div class="card border-0 shadow-sm text-center">
            <div class="card-body py-5">
                ...
                <?php if ($student): ?>
                <p class="text-muted small mt-3 mb-0">Student No: <?= $student['student_number'] ?></p>
                <?php endif; ?>
                <?php if ($enrollment): ?>
                <p class="text-muted small mb-0">Class: <?= $enrollment['class_code'] ?> <?= $enrollment['stream_name'] ?></p>
                <?php endif; ?>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-8">
        ...
        <div class="card border-0 shadow-sm mt-4">
            ...
            <div class="card-body">
                ...
                <form action="/student/profile/security" method="POST">
                    <?= View::csrf() ?>
